# platform-bible-translation-notes

Translation notes extension to be used within Platform.bible.
...
- `src/` contains the source code for the extension
  ...
  - `src/types/platform-bible-translation-notes.d.ts` is this extension's types file that defines how other extensions can use this extension through the `papi`. It is copied into the build folder
